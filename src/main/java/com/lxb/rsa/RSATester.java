...
public class RSATester {
    ...
    static void test() throws Exception {
      ...
      String  password= new String(encodedData).replaceAll(" ","+");
        byte[] decodedData = RSAUtils.decryptByPrivateKey(password.getBytes(), privateKey);
    ...
    static void testSign() throws Exception {
      ...
      //  byte[] decodedData = RSA.decryptByPublicKey(DigestUtil.decryptBase64(code64), publicKey);
        byte[] decodedData = RSAUtils.decryptByPublicKey(DigestUtil.decryptBase64(code64), publicKey);
        String target = new String(decodedData);
